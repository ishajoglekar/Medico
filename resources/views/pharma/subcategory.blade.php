        ...
        <div class="col-md-3" id="sidebar">
            ...
            <div class="sub-categories">
                <div class="sub-category">
                    <p class="main-sub-category fa fa-angle-right" data-id="1"><i class=""></i> &nbsp;{{$singleCategory->name}}</p>
                    <div id="1" class="d-none">
                        <div class="list-sub-category">
                            @foreach ($singleCategory->subcategories as $sub)
                                {{-- <p class="main-list-sub-category">{{$sub->name}}</p> --}}
