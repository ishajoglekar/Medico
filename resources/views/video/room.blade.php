    ...
    <body class="antialiased">
        ...
        <div class="content">
            ...
            <div class="d-flex actions">
                ...
                <div class="btn btn-primary p-2 off" id="leave" onclick="leave()" style="width:4rem;height:4rem;transform: rotate(137deg);"><i class="fa fa-phone p-2" style="padding:27%; margin-bottom:1.3rem; font-size:1.3rem;"></i><hr id="slash"style="height: 2rem;width: 2px;
                    background: #000;
                    transform: rotate(78deg);
                    bottom: -81%;
                    position: absolute;
                    left: 5.7rem;width:2px;background:#fff;display:none"></div>
            </div>
        </div>
    </body>
</html>
