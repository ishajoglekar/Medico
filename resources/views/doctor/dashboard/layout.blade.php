...
<head>
  ...
  <link href="{{asset('dashboard/css/common-styles.css')}}" rel="stylesheet">
...
<body>
  <section id="container">
    ...
    <a id="chat" href="{{route('receive')}}">
        <i class="fa fa-comment"></i>
    </a>
    <!--header start-->
    @include('doctor.dashboard.partials._header')
    <!--header end-->

    <!--sidebar start-->
    @include('doctor.dashboard.partials._sidebar')
    <!--sidebar end-->
  ...
  <script type="text/javascript" src="{{asset('dashboard/lib/advanced-datatable/js/DT_bootstrap.js')}}lib/advanced-datatable/js/DT_bootstrap.js"></script>
...
<script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
  ...
  <script>
      ...
      var user_id = {{auth()->user()->id}};
        // Echo.private(`notify-doctor.${user_id}`)
        //     .listen('NotifyDoctor', (e) => {
