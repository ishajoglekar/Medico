...
@section('dashboard-title')
    <div class="col-md-12">
        <div class="col-md-8">My profile</div>
        <a href="{{route('user.edit',$user->id)}}" class="btn btn-primary">Edit personal data</a>
        <a href="{{route('manufacturer.edit',$user->id)}}" class="btn btn-primary">Edit company data</a>
    </div>
@endsection
    ...
    <div class="col-md-12">
        <div class="card" style="box-shadow:none;margin-top:3rem">
            <div class="card-body">
                ...
                <div class="col-md-6">
                    <div class="form-group col-md-12">
                        <label for="company_name">Company Description<span>*<span></label>
                        <textarea class="form-control" name="company_name" id="company_name" cols="30" rows="9" disabled>{{$user->manufacturer->description}}</textarea>
                    </div>
                </div>
            </div>
        </div>
