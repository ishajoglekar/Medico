...
<head>
  ...
  <style>
    ...
    <link rel="stylesheet" href="{{asset('dashboard/css/user-dashboard.css')}}">
...
<body>
  <section id="container">
    <!--header start-->
    @include('user.dashboard.partials._header')
    <!--header end-->

    @include('layouts.for-providers')

    <!--sidebar start-->
    @include('user.dashboard.partials._sidebar')
    <!--sidebar end-->

    <!--main content start-->
    <div class="dashboard-content">
    <div class="title"><h4 class="w-100">@yield('dashboard-title')</h4></div>
        @yield('main-content')
    </div>
    <!--main content end-->
    <!--footer start-->
  ...
  <script>
        ...
        .listen('NotificationEvent',(e)=>{
                console.log("hii");
                console.log(e.message[1].message+e.message[2]);
                var route;
                if(e.message[1].name == "prescription"){
                    route = "dashboard/user/prescription";
                }else{
                    route = "dashboard/user/slots";
                }
